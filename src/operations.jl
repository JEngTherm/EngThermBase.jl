...
# ξ + Pv --> ψ  with Unitful promotion
+(x::xiamt{𝗽,𝘅,𝗯}, y::Pvamt{𝘀,𝘆,𝗯}) where {𝗽,𝘀,𝘅,𝘆,𝗯} = begin
    𝞇(+(amt(x), amt(y)))
end
+(y::Pvamt{𝘀,𝘆,𝗯}, x::xiamt{𝗽,𝘅,𝗯}) where {𝗽,𝘀,𝘅,𝘆,𝗯} = x + y        # as to fallback

# ψ - Pv --> ξ  with Unitful promotion
-(x::psamt{𝗽,𝘅,𝗯}, y::Pvamt{𝘀,𝘆,𝗯}) where {𝗽,𝘀,𝘅,𝘆,𝗯} = begin
    𝝽(-(amt(x), amt(y)))
end
-(y::Pvamt{𝘀,𝘆,𝗯}, x::psamt{𝗽,𝘅,𝗯}) where {𝗽,𝘀,𝘅,𝘆,𝗯} = -(x - y)     # as to fallback

# ψ - ξ --> Pv  with Unitful promotion
-(x::psamt{𝗽,𝘅,𝗯}, y::xiamt{𝘀,𝘆,𝗯}) where {𝗽,𝘀,𝘅,𝘆,𝗯} = begin
    𝗣𝘃(-(amt(x), amt(y)))
end
-(y::xiamt{𝘀,𝘆,𝗯}, x::psamt{𝗽,𝘅,𝗯}) where {𝗽,𝘀,𝘅,𝘆,𝗯} = -(x - y)     # as to fallback
...
# RT / R --> T
/(x::RTamt{𝗽,𝘅,𝗯}, y::R_amt{𝘀,𝘆,𝗯}) where {𝗽,𝘀,𝘅,𝘆,𝗯} = begin
    𝗧(/(amt(x), amt(y)))
end
...
# Ts / s --> T
/(x::Tsamt{𝗽,𝘅,𝗯}, y::s_amt{𝘀,𝘆,𝗯}) where {𝗽,𝘀,𝘅,𝘆,𝗯} = begin
    𝗧(/(amt(x), amt(y)))
end
...
# g / T --> -y
/(x::g_amt{𝕡,𝕩,𝕓}, y::T_amt{𝕢,𝕪}) where {𝕡,𝕢,𝕩,𝕪,𝕓} = begin
    -𝘆(/(amt(x), amt(y)))
end
...
==(x::AMOUNTS, y::AMOUNTS) = ==(promote(x(), y())...)

==(x::ENERGYA, y::ENERGYA) = ==(promote(x(), y())...) && typeof(x) == typeof(y)

==(x::NTROPYA, y::NTROPYA) = ==(promote(x(), y())...) && typeof(x) == typeof(y)

isapprox(x::AMOUNTS, y::AMOUNTS; kwargs...) = isapprox(promote(x(), y())...; kwargs...)

for FUN in (:>, :<)
    @eval ($FUN)(x::𝗧, y::𝗧) where 𝗧<:AMOUNTS = ($FUN)(promote(x(), y())...)
end
