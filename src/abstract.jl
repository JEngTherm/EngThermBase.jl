...
mkSingleTy(        :MA                          , :intensiveBase                , "the MAss base"                                                       )
mkSingleTy(        :MO                          , :intensiveBase                , "the MOlar base"                                                      )
mkOneAbsTy(      :extensiveBase                 , :ThermodynamicBase            , "non-intensive bases"                                                 )
mkSingleTy(        :SY                          , :extensiveBase                , "the SYstem (extensive) base"                                         )
mkSingleTy(        :DT                          , :extensiveBase                , "the Time Derivative (rate) base"                                     )
